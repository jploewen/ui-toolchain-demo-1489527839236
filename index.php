...
<body onload="loadItems(items)">
	...
	<img id="mynewlog" src="http://upload.wikimedia.org/wikipedia/commons/2/26/Invalidenpark%2C_Berlin-Mitte%2C_360x180%2C_160326%2C_ako.jpg" height="25%" width="25%" alt="Oops">
	...
	<img id="mylogo" src="http://upload.wikimedia.org/wikipedia/commons/0/07/Multi-use_water_bottle.JPG" height="25%" width="25%" alt="Oops">
